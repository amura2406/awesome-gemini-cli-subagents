...
description: Install Gemini CLI agents from the awesome-gemini-cli-subagents repository.
...
4. Install agents to global (`~/.gemini/agents/`) or local (`.gemini/agents/`) directory
5. Show details about a specific agent before installing
6. Uninstall agents

## GitHub API Endpoints

- Categories list: `https://api.github.com/repos/ankitmundada/awesome-gemini-cli-subagents/contents/categories`
- Agents in category: `https://api.github.com/repos/ankitmundada/awesome-gemini-cli-subagents/contents/categories/{category-name}`
- Raw agent file: `https://raw.githubusercontent.com/ankitmundada/awesome-gemini-cli-subagents/main/categories/{category-name}/{agent-name}.md`
...
1. Ask if they want global installation (`~/.gemini/agents/`) or local (`.gemini/agents/`)
2. For local: Check if `.gemini/` directory exists, create `.gemini/agents/` if needed
...
**You:**
1. Ask: "Install globally (~/.gemini/agents/) or locally (.gemini/agents/)?"
2. Download from GitHub
3. Save to chosen directory
4. Confirm: "✓ Installed python-pro.md to ~/.gemini/agents/"
